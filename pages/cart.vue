...
const total = computed(() => 
  cart.reduce((acc, cartEntry) => acc + cartEntry.totalPrice, 0)
)

</script>

<template>
  <main class="cart a-container">
    <h2>Your Cart</h2>
